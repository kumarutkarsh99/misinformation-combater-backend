...
- **Formal Reporting** — ability to **report suspicious content to authorities**  
...
- **Geographic View (India map with points)** — see where misinformation originates and spreads  
